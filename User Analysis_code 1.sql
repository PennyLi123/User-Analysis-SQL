...
-- STEP 3: Analyse the data at the user level (how many sessions did each user have?)
-- STEP 4: Aggregate the use-level analysis to generate your behavioral analysis
...
WHERE created_at < '2014-11-01' -- the date of the assignment
    ...
    LEFT JOIN website_sessions
          ...
          AND website_sessions.is_repeat_session=1 -- was a repeat session, for creating sessions_repeat TABLE
          ...
          AND website_sessions.created_at >= '2014-01-01' -- precribed date range in assignment
          ;
    
SELECT * FROM sessions_w_repeats; -- see the 'sessions_w_repeats' TABLE just created above
