...
-- STEP2: Use the user_id values from Step 1 to find any repeat sessions those users had
-- STEP3: Find the created_at times for first and second sessions of the repeat sessions
-- STEP4: Find the differences between first and second sessions at a user level
